        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/signup-new-user/new" method="POST">
                    @csrf
                    <div>
                        <label for="name" class="block text-start mb-2 text-sm font-medium text-gray-900 dark:text-white">Your name</label>
                        <input 
                        type="text" 
                         name="name"
                          id="name" 
                                ...
                                {{$message}}
                                    ...
                                    <div>
                                        ...
                                        for="password_confirmation"
                                         class="block text-start mb-2 text-sm font-medium text-gray-900 dark:text-white">                                            Confirm Password
                                        </label>
                                        <input 
                                        type="password"
