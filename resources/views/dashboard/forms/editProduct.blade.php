                            ...
                            <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
                                <div
                                    ...
                                    <div class="block w-full overflow-x-auto">
                                        <!-- Projects table -->
                                        <form class="space-y-4 md:space-y-6" action="/addNewProduct" method="POST">
                                            @csrf
                                           
                                            
                                            <div style="display:flex">
                                                <span class="pl-4"> <label for="email" class="block text-start mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                    Product Name</label>
                                                <input
                                                 type="text" 
                                                  name="name" 
                                                  id="name"
                                                  value={{$products->name}}
                                                  class="bg-gray-50 w-1/4 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required />
                                                  @error('name')
                                                 ...
                                                 type="text" 
                                                  ...
                                                  <div style="display:flex">
                                                    ...
                                                    <input
                                                     type="text" 
                                                      name="discount" 
                                                      value={{asset($products->discount)? '0':  $products->discount}}
...
<textarea id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here...">
    ...
    {{$products->description}}
                                                          ...
                                                          <div class="relative w-full px-4 mt-4 max-w-full flex-grow flex-1 text-right">
                                                            <button
