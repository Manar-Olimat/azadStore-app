{{-- Reviews --}}
@props(['reviews','productid','rateAvg'])
    ...
    @csrf
        ...
        {{-- <div class="w-1/4"> --}}
            <label for="rate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Rating 1-5</label>
            <input type="text" id="rate" name="rate" class="w-1/4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
...
<hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">
      ...
      <div class="mt-4 flex items-center">
        ...
        <div class="ml-4">
          ...
          <p class="mt-0.5 text-xs text-gray-500">Based on {{count($reviews)}} reviews </p>
        </div>
      </div>
