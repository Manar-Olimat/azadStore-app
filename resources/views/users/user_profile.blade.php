                        ...
                        <div class="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                            <div class="profile-pic text-center mb-5">
                                ...
                                <div>
                                    <div class="relative h-28 w-28 mx-auto">
                                        <img src="https://shreethemes.in/techwind/layouts/assets/images/client/05.jpg"
                            ...
                            <div class="border-t border-gray-100 dark:border-gray-700">
                                <ul class="list-none sidebar-nav mb-0 mt-3" id="myTab" data-tabs-toggle="#myTabContent"
                                    ...
                                    <li class="sidelist pb-6" role="presentation">
                                        <a id="settings-tab" data-tabs-target="#settings" type="button" role="tab"
                                    ...
                                    <li class="sidelist pb-6" role="presentation">
                                        <a id="contacts-tab" data-tabs-target="#contacts" type="button" role="tab"
