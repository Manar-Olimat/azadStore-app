                                    ...
                                    <div class="block w-full overflow-x-auto">
                                        ...
                                        <table class="items-center w-full bg-transparent border-collapse">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   <td   class="font-bold border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                                                    ...
                                                    <td   class="font-bold border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                                                        ...
                                                        <td   class="font-bold border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                                                            <a href="editProduct/{{$item->id}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                                            <a href="removeProduct?id={{$item->id}}" class="font-medium text-red-600 dark:text-red-500 hover:underline">Remove</a>
