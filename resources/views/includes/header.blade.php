            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <input type="text" name="search" id="search"
                      ...
                      placeholder="search">
                  <button
                      class="bg-red-500 border border-primary text-white px-8 rounded-r-md  hover:text-primary transition">Search</button>
...
{{-- CART ICON --}}
{{-- <div class="flex justify-center md:block">
	<a href="/cart" class="relative text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" href="#">
...
<div class="flex items-center space-x-4">
  <a href="/wishlist" class="text-center pl-6 text-gray-700 hover:text-primary transition relative">
      <div class="text-2xl">
        ...
        <div class="container flex">
            ...
            <div class="flex items-center justify-between flex-grow pl-12">
                <div class="flex items-center space-x-6 capitalize">
                    <a href="/" class="text-gray-200 pl-8 hover:text-white transition">Home</a>
                    <a href="/all-products" class="text-gray-200 pl-8 hover:text-white transition">Shop</a>
                    <a href="/about-us" class="text-gray-200 hover:text-white pl-8 transition">About us</a>
                    <a href="/contact-us" class="text-gray-200 hover:text-white pl-8 transition">Contact us</a>
                </div>
